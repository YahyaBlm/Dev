...
<head>
  ...
  <link rel="stylesheet" href="./public/assets/css/oeuvre.css" />
...
<body>
  ...
  <main>
    <h1 class="title titre">Nom de l'oeuvre</h1>

    <section class="oeuvre-container">
      <div class="card">
        <img src="https://via.placeholder.com/300x400" alt="Image Oeuvre1" />
